            ...
            <main>
                <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
                    <symbol id="check" viewBox="0 0 16 16">
                        <title>Check</title>
                        <path color="#090" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    </symbol>
                </svg>
                <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
                    ...
                    <div className="col">
                        <div className="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div className="card-body">
                                <h1 className="card-title pricing-card-title">$1<small className="text-muted fw-light">/mo</small></h1>
                                <ul className="list-unstyled mt-3 mb-4">
                    ...
                    <div className="col">
                        <div className="card mb-4 rounded-3 shadow-sm border-primary">
                            ...
                            <div className="card-body">
                                <h1 className="card-title pricing-card-title">$2.9<small className="text-muted fw-light">/mo</small></h1>
                                <ul className="list-unstyled mt-3 mb-4">
